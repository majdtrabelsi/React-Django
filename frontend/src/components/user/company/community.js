  ...
  return (
    <div style={styles.pageContainer}>
      ...
      <div style={styles.sidebar}>
        ...
        <form onSubmit={handleCreateCategory} style={{ marginTop: '1rem', width: '100%' }}>
          <input
            type="text"
            ...
            style={styles.input}
          />
          <button type="submit" style={{ ...styles.button, marginTop: '0.5rem', width: '100%' }}>
            + Add
          </button>
        </form>
      </div>
        ...
        <div style={styles.messagesContainer}>
          {posts.length === 0 ? (
            ...
            posts.map((post) => (
                ...
                {/* Reply Form */}
                <form onSubmit={(e) => handleReplySubmit(e, post.id)} style={styles.replyForm}>
                  <input
                    type="text"
                    placeholder="Your Name"
                    value={replyInputs[post.id]?.name || ''}
                    onChange={(e) =>
                      setReplyInputs((prev) => ({
                        ...prev,
                  ...
                  <input
                    ...
                    value={replyInputs[post.id]?.message || ''}
                    onChange={(e) =>
                      setReplyInputs((prev) => ({
                        ...prev,
                        [post.id]: { ...prev[post.id], message: e.target.value },
                      }))
                    }
                    required
                    style={styles.replyInput}
                  />
                  <button type="submit" style={styles.replyButton}>Reply</button>
                </form>
              </div>
